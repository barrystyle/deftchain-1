...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s deftchain-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  deftchain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded deftchain transaction") + "\n" +
              "  deftchain-tx [options] -create [commands]   " + _("Create hex-encoded deftchain transaction") + "\n" +
              "\n";
